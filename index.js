...
console.log(createMenuItem("Turkey Club", "10", "Lunch"));
console.log(createMenuItem("Bone In Ribeye", "27", "Dinner"));
console.log(createMenuItem("Pistachio Cake", "9", "Dessert"));
...
*/
reviews.push({ name: "Shane", rating: 1, feedback: "Simply turrible" });
console.log(reviews);
